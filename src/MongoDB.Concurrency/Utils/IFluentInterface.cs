...
namespace MongoDB.Concurrency.Utils
{
    ...
    ///         </item>
    ///         <item>
    ///             When using Resharper, be sure to configure it to respect the attribute: Options, go to Environment |
    ///             IntelliSense | Completion Appearance and check "Filter members by [EditorBrowsable] attribute".
    ///         </item>
    ///     </list>
